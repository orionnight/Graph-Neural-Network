...
#path_train = '../../py_mind_tr_oas_ra'
#path_valid = '../../py_mind_va_oas_ra'
path_test  = '../../pytor_test'
#output_path = 'output_unali_col'
...
for tes in range(len(file_test)):
    ...
    sio.savemat('./' + output_path + '/'+ file_test[tes],{'prob_pred':prob_pred,'gt':gt, 'labels':labels})
